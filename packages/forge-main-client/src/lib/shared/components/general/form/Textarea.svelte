<script lang="ts">
	...
	$: textareaProps = {
		...
		...$$restProps,
		class: [
			'min-h-[100px] bg-gallery border-gallery text-base rounded-3xl font-secondary text-rhino block w-full ring-0 focus:ring-0 border-2 aria-[invalid]:border-error focus:border-2 focus:border-cobalt',
...
<div>
	...
	<div class="relative">
		<textarea name={field} bind:value={$value} {...textareaProps} />
	</div>
</div>
