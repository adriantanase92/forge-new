export const stylingClasses = {
	advanced: {
		...
		tableHead: {
			...
			thEl: 'border-b border-solid border-gallery bg-rhino p-2 text-left font-primary font-bold sm:border-none sm:bg-transparent sm:py-2 sm:pl-2 sm:pr-4',
			thActionsEl:
				'flex h-[49px] items-center border-b border-solid border-rhino bg-rhino p-2 text-left font-primary font-bold sm:table-cell sm:h-auto sm:border-none sm:bg-transparent sm:py-2 sm:pl-2 sm:pr-4 sm:text-right'
		},
		tableBody: {
	...
	simple: {
		...
		tableHead: {
			...
			trEl: 'last:mb-0',
			thEl: 'text-left font-primary font-bold border-none bg-transparent py-2 pl-2 pr-4',
			thActionsEl:
				'font-primary font-bold border-none bg-transparent py-2 pl-2 pr-4 text-right'
		},
		tableBody: {
			el: '',
			trEl: 'last:mb-0',
